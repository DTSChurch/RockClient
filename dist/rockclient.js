...
$parcel$export(module.exports, "RockClient", () => $4fa36e821943b400$export$8bf6809db3440abc);
const $4fa36e821943b400$var$_fetch = window.fetch;
const $4fa36e821943b400$var$_Rock = window.Rock;
function $4fa36e821943b400$var$_createCache() {
...
class $4fa36e821943b400$export$8bf6809db3440abc {
    constructor(config){
        if ($4fa36e821943b400$var$_fetch === undefined) throw new Error('Unsupported Browser');
        config = config || {};
        if ($4fa36e821943b400$var$_Rock && config.url === undefined) {
        ...
        this._memoryCache = $4fa36e821943b400$var$_createCache();
        this.API = {};
    }
    async authenticate() {
        if (!this.token && (!this.sameOrigin || this.username && this.password)) try {
            const response = await $4fa36e821943b400$var$_fetch(`${this.url}/Auth/Login`, {
                method: 'POST',
                body: {
    ...
    async _request(req, ctx) {
        ...
        try {
            ...
            const response = await $4fa36e821943b400$var$_fetch(_url.href, {
                method: method,
                headers: headers,
                body: req.data
            });
...
window.DTS.RockClient = $4fa36e821943b400$export$8bf6809db3440abc;


//# sourceMappingURL=rockclient.js.map
